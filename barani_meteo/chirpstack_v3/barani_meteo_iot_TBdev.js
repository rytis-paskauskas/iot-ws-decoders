// Monolithic Payload Decoder for Barani Meteo Helix, Barani Meteo
// Rain IoT and Barani Meteo Wind Iot (all with LoRa Tx)
// Time-stamp: <2025-04-02 16:30:21 rytis>
...
function Decode(fPort, bytes)
{
	...
	Index = reader.readBits(8);
	Battery = Round(reader.readBits(5)*0.05+3, 2);
	Rain = Round(reader.readBits(12), 1);
	Rain_time = Round(reader.readBits(8), 1);
	Frost_alert = Round(reader.readBits(1)*1, 0);
	Heater_on = Round(reader.readBits(1)*1, 0);
	RainIntensityCorrection = Round(reader.readBits(12)*0.01,2);
